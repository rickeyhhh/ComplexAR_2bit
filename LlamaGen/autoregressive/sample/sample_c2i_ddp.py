...
def main(args):
    ...
    # Apply QAT replacement before loading checkpoint so that
    # reorder2 cached permutation buffers can be restored from ckpt.
    ...
    # Check cached permutation status and convert to inference mode
    if args.quant_method:
...
if __name__ == "__main__":
    ...
    ### for QAT
    parser.add_argument("--quant-method", type=str, default='')
