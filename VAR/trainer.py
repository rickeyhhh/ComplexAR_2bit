    ...
    def train_step(
        ...
        if it == 0 or it in metric_lg.log_iters:
            ...
            if grad_norm is not None:
                ...
                grad_norm = 0.0  # No gradient update in this step
        ...
        for k in ('var_wo_ddp', 'vae_local', 'var_opt'):
            ...
            if m is not None:
                ...
                try:
                    ...
                    # Quantization mode switches (e.g., EfficientQAT -> Omni) can change optimizer groups.
                    if k == 'var_opt' and not strict:
                        print(f'[VARTrainer.load_state_dict] skip restoring {k}: {e}')
                        ret = None
                    else:
                        raise
                if ret is not None:
