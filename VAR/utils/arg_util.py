...
class Args(Tap):
    ...
    let_lr: float = 5e-3    # LET learning rate for Omni quantization
    lwc_lr: float = 1e-2    # LWC learning rate for Omni quantization
    ...
    omni_subset_size: int = 128   # number of sampled images for Omni calibration/training subset
